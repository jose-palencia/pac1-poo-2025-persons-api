...
namespace Persons.API.Migrations
{
    ...
    [Migration("20250730001533_AddFieldsRefreshToken")]
    partial class AddFieldsRefreshToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Persons.API.Database.Entities.CountryEntity", b =>
                {
                    b.HasOne("Persons.API.Database.Entities.UserEntity", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Persons.API.Database.Entities.UserEntity", "UpdatedByUser")
                        .WithMany()
